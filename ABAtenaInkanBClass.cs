...
// * ‹Æ–±–¼          ˆ¶–¼ŠÇ—ƒVƒXƒeƒ€
// * 
// * ƒNƒ‰ƒX–¼        ˆ¶–¼ˆóŠÓ‚c‚`(ABAtenaInkanBClass)
// * 
...
// * 2003/09/11 000004     ˆóŠÓ”Ô†‚ÅŽæ“¾‚·‚éƒƒ\ƒbƒh‚ÌŽd—l’Ç‰Á
// * 2004/11/11 000005     ƒf[ƒ^ƒ`ƒFƒbƒN‚ðs‚È‚í‚È‚¢
// * 2005/02/15 000006     ƒŒƒXƒ|ƒ“ƒX‰ü‘PF‚r‚p‚k•¶ì¬‚ÌC³     
...
namespace Densan.Reams.AB.AB000BB
{
    ...
    public class ABAtenaInkanBClass
    {
        ...
        #region ƒƒ\ƒbƒh
        // ************************************************************************************************
        // * ƒƒ\ƒbƒh–¼     ˆ¶–¼ˆóŠÓƒ}ƒXƒ^’Šo
        // * 
        // * \•¶           Public Function GetAtenaInkan(ByVal strJuminCD As String) As DataSet
        // * 
        // * ‹@”\@@    @@ˆ¶–¼ˆóŠÓƒ}ƒXƒ^‚æ‚èŠY“–ƒf[ƒ^‚ðŽæ“¾‚·‚éBB
        // * 
        // * ˆø”           strJuminCD As String  :Z–¯ƒR[ƒh
        // * 
        // * –ß‚è’l         Žæ“¾‚µ‚½ˆ¶–¼ˆóŠÓƒ}ƒXƒ^‚ÌŠY“–ƒf[ƒ^iDataSetj
        // *                   \‘¢FcsAtenaInkanEntity    ƒCƒ“ƒeƒŠƒZƒ“ƒXFABAtenaInkanEntity
        // ************************************************************************************************
...
#error Cannot convert EmptyStatementSyntax - see comment for details
                /* Cannot convert EmptyStatementSyntax, CONVERSION ERROR: Conversion for EmptyStatement not implemented, please report this issue in '' at character 6772
...
#error Cannot convert LiteralExpressionSyntax - see comment for details
                ...
                ;
#error Cannot convert EmptyStatementSyntax - see comment for details
                /* Cannot convert EmptyStatementSyntax, CONVERSION ERROR: Conversion for EmptyStatement not implemented, please report this issue in '' at character 7697
                ...
                ;
#error Cannot convert EmptyStatementSyntax - see comment for details
                /* Cannot convert EmptyStatementSyntax, CONVERSION ERROR: Conversion for EmptyStatement not implemented, please report this issue in '' at character 7800
...
#error Cannot convert LiteralExpressionSyntax - see comment for details
                ...
                ;
#error Cannot convert EmptyStatementSyntax - see comment for details
                /* Cannot convert EmptyStatementSyntax, CONVERSION ERROR: Conversion for EmptyStatement not implemented, please report this issue in '' at character 8349
        ...
        // * ‹@”\@@    @@ˆ¶–¼ˆóŠÓƒ}ƒXƒ^‚æ‚èŠY“–ƒf[ƒ^‚ðŽæ“¾‚·‚éBB
        // * 
        // * ˆø”           strInkanNO As String  : ˆóŠÓ”Ô†
        // * 
        // * –ß‚è’l         Žæ“¾‚µ‚½ˆ¶–¼ˆóŠÓƒ}ƒXƒ^‚ÌŠY“–ƒf[ƒ^iDataSetj
        // *                   \‘¢FcsAtenaInkanEntity    ƒCƒ“ƒeƒŠƒZƒ“ƒXFABAtenaInkanEntity
        // ************************************************************************************************
...
#error Cannot convert LiteralExpressionSyntax - see comment for details
                ...
                ;
#error Cannot convert EmptyStatementSyntax - see comment for details
                /* Cannot convert EmptyStatementSyntax, CONVERSION ERROR: Conversion for EmptyStatement not implemented, please report this issue in '' at character 12395
                ...
                ;
#error Cannot convert EmptyStatementSyntax - see comment for details
                /* Cannot convert EmptyStatementSyntax, CONVERSION ERROR: Conversion for EmptyStatement not implemented, please report this issue in '' at character 12498
...
#error Cannot convert EmptyStatementSyntax - see comment for details
        ...
        public int InsertAtenaInkan(DataRow csDataRow)
        {
            ...
            try
            {
                ...
                {
                    // *—š—ð”Ô† 000006 2005/02/15 C³ŠJŽn
                    CreateInsertSQL(csDataRow);
                    // * corresponds to VS2008 Start 2010/04/16 000007
                    // '''Call CreateSQL(csDataRow)
                    // * corresponds to VS2008 End 2010/04/16 000007
                    // *—š—ð”Ô† 000006 2005/02/15 C³I—¹
                }
                ...
                csDataRow(ABAtenaInkanEntity.SAKUJOFG) = "0";                                            // íœƒtƒ‰ƒO
                csDataRow(ABAtenaInkanEntity.KOSHINCOUNTER) = decimal.Zero;                              // XVƒJƒEƒ“ƒ^
                csDataRow(ABAtenaInkanEntity.SAKUSEINICHIJI) = strUpdateDateTime;                        // ì¬“úŽž
                csDataRow(ABAtenaInkanEntity.SAKUSEIUSER) = m_cfControlData.m_strUserId;                 // ì¬ƒ†[ƒU[
                csDataRow(ABAtenaInkanEntity.KOSHINNICHIJI) = strUpdateDateTime;                         // XV“úŽž
                csDataRow(ABAtenaInkanEntity.KOSHINUSER) = m_cfControlData.m_strUserId;                  // XVƒ†[ƒU[
...
#error Cannot convert LiteralExpressionSyntax - see comment for details
               /* Cannot convert LiteralExpressionSyntax, System.ArgumentOutOfRangeException: Length cannot be less than zero.
                ...
                // SQL‚ÌŽÀs
#error Cannot convert EmptyStatementSyntax - see comment for details
                /* Cannot convert EmptyStatementSyntax, CONVERSION ERROR: Conversion for EmptyStatement not implemented, please report this issue in '' at character 17553
...
#error Cannot convert LiteralExpressionSyntax - see comment for details
                ...
                ;
#error Cannot convert EmptyStatementSyntax - see comment for details
                /* Cannot convert EmptyStatementSyntax, CONVERSION ERROR: Conversion for EmptyStatement not implemented, please report this issue in '' at character 18444
                ...
                ;
#error Cannot convert EmptyStatementSyntax - see comment for details
                /* Cannot convert EmptyStatementSyntax, CONVERSION ERROR: Conversion for EmptyStatement not implemented, please report this issue in '' at character 18547
...
#error Cannot convert LiteralExpressionSyntax - see comment for details
                ...
                ;
#error Cannot convert EmptyStatementSyntax - see comment for details
                /* Cannot convert EmptyStatementSyntax, CONVERSION ERROR: Conversion for EmptyStatement not implemented, please report this issue in '' at character 19096
        ...
        public int UpdateAtenaInkan(DataRow csDataRow)
        {
            ...
            try
            {
                ...
                // ‹¤’Ê€–Ú‚Ì•ÒW‚ðs‚¤
                csDataRow(ABAtenaInkanEntity.TANMATSUID) = m_cfControlData.m_strClientId; // ’[––‚h‚c
                csDataRow(ABAtenaInkanEntity.KOSHINCOUNTER) = (decimal)csDataRow(ABAtenaInkanEntity.KOSHINCOUNTER) + 1m;   // XVƒJƒEƒ“ƒ^
                csDataRow(ABAtenaInkanEntity.KOSHINNICHIJI) = m_cfRdbClass.GetSystemDate().ToString("yyyyMMddHHmmssfff");   // XV“úŽž
                csDataRow(ABAtenaInkanEntity.KOSHINUSER) = m_cfControlData.m_strUserId;   // XVƒ†[ƒU[
...
#error Cannot convert LiteralExpressionSyntax - see comment for details
               /* Cannot convert LiteralExpressionSyntax, System.ArgumentOutOfRangeException: Length cannot be less than zero.
                ...
                // SQL‚ÌŽÀs
#error Cannot convert EmptyStatementSyntax - see comment for details
                /* Cannot convert EmptyStatementSyntax, CONVERSION ERROR: Conversion for EmptyStatement not implemented, please report this issue in '' at character 23648
...
#error Cannot convert LiteralExpressionSyntax - see comment for details
                ...
                ;
#error Cannot convert EmptyStatementSyntax - see comment for details
                /* Cannot convert EmptyStatementSyntax, CONVERSION ERROR: Conversion for EmptyStatement not implemented, please report this issue in '' at character 24539
                ...
                ;
#error Cannot convert EmptyStatementSyntax - see comment for details
                /* Cannot convert EmptyStatementSyntax, CONVERSION ERROR: Conversion for EmptyStatement not implemented, please report this issue in '' at character 24642
...
#error Cannot convert LiteralExpressionSyntax - see comment for details
                ...
                ;
#error Cannot convert EmptyStatementSyntax - see comment for details
                /* Cannot convert EmptyStatementSyntax, CONVERSION ERROR: Conversion for EmptyStatement not implemented, please report this issue in '' at character 25191
...
#error Cannot convert LiteralExpressionSyntax - see comment for details
               /* Cannot convert LiteralExpressionSyntax, System.ArgumentOutOfRangeException: Length cannot be less than zero.
                ...
                ;
#error Cannot convert EmptyStatementSyntax - see comment for details
                /* Cannot convert EmptyStatementSyntax, CONVERSION ERROR: Conversion for EmptyStatement not implemented, please report this issue in '' at character 28364
                ...
                ;
#error Cannot convert EmptyStatementSyntax - see comment for details
                /* Cannot convert EmptyStatementSyntax, CONVERSION ERROR: Conversion for EmptyStatement not implemented, please report this issue in '' at character 28467
...
#error Cannot convert LiteralExpressionSyntax - see comment for details
                ...
                ;
#error Cannot convert EmptyStatementSyntax - see comment for details
                /* Cannot convert EmptyStatementSyntax, CONVERSION ERROR: Conversion for EmptyStatement not implemented, please report this issue in '' at character 29016
                ...
                ;
#error Cannot convert EmptyStatementSyntax - see comment for details
                /* Cannot convert EmptyStatementSyntax, CONVERSION ERROR: Conversion for EmptyStatement not implemented, please report this issue in '' at character 29524
        ...
        {
            const string THIS_METHOD_NAME = "CreateSQL";
            // ‰¼ƒRƒ@Dim strInsertColumn As String
            // ‰¼ƒRƒ@Dim strInsertParam As String
            UFParameterClass cfUFParameterClass;
...
#error Cannot convert LiteralExpressionSyntax - see comment for details
               /* Cannot convert LiteralExpressionSyntax, System.ArgumentOutOfRangeException: Length cannot be less than zero.
                ...
                ;
#error Cannot convert EmptyStatementSyntax - see comment for details
                /* Cannot convert EmptyStatementSyntax, CONVERSION ERROR: Conversion for EmptyStatement not implemented, please report this issue in '' at character 33126
                ...
                ;
#error Cannot convert EmptyStatementSyntax - see comment for details
                /* Cannot convert EmptyStatementSyntax, CONVERSION ERROR: Conversion for EmptyStatement not implemented, please report this issue in '' at character 33229
...
#error Cannot convert LiteralExpressionSyntax - see comment for details
                ...
                ;
#error Cannot convert EmptyStatementSyntax - see comment for details
                /* Cannot convert EmptyStatementSyntax, CONVERSION ERROR: Conversion for EmptyStatement not implemented, please report this issue in '' at character 33778
                ...
                ;
#error Cannot convert EmptyStatementSyntax - see comment for details
                /* Cannot convert EmptyStatementSyntax, CONVERSION ERROR: Conversion for EmptyStatement not implemented, please report this issue in '' at character 34336
        ...
        // * 
        // * ‹@”\@@       ˆ¶–¼ˆóŠÓƒ}ƒXƒ^‚Ìƒf[ƒ^®‡«ƒ`ƒFƒbƒN‚ðs‚¢‚Ü‚·B
        // * 
        ...
        private void CheckColumnValue(string strColumnName, string strValue)
        {
            ...
            try
            {
                ...
                {
                    case var @case when @case == ABAtenaInkanEntity.JUMINCD:                         // Z–¯ƒR[ƒh
                        {
                    ...
                    case var case1 when case1 == ABAtenaInkanEntity.SHICHOSONCD:                     // Žs’¬‘ºƒR[ƒh
                        {
                            if (!UFStringClass.CheckNumber(strValue))
                            {
                                m_cfErrorClass = new UFErrorClass(ABConstClass.THIS_BUSINESSID);
                    ...
                    case var case2 when case2 == ABAtenaInkanEntity.KYUSHICHOSONCD:                  // ‹ŒŽs’¬‘ºƒR[ƒh
                        {
                            if (!UFStringClass.CheckNumber(strValue))
                            {
                                m_cfErrorClass = new UFErrorClass(ABConstClass.THIS_BUSINESSID);
                    ...
                    case var case3 when case3 == ABAtenaInkanEntity.INKANNO:                         // ˆóŠÓ”Ô†
                        {
                    ...
                    case var case4 when case4 == ABAtenaInkanEntity.INKANTOROKUKB:                   // ˆóŠÓ“o˜^‹æ•ª
                        {
                            if (!UFStringClass.CheckNumber(strValue))
                            {
                                m_cfErrorClass = new UFErrorClass(ABConstClass.THIS_BUSINESSID);
                    ...
                    case var case5 when case5 == ABAtenaInkanEntity.TANMATSUID:                      // ’[––ID
                        {
                            if (!UFStringClass.CheckANK(strValue))
                            {
                                m_cfErrorClass = new UFErrorClass(ABConstClass.THIS_BUSINESSID);
                    ...
                    case var case6 when case6 == ABAtenaInkanEntity.SAKUJOFG:                        // íœƒtƒ‰ƒO
                        {
                            if (!UFStringClass.CheckNumber(strValue))
                            {
                                m_cfErrorClass = new UFErrorClass(ABConstClass.THIS_BUSINESSID);
                    ...
                    case var case7 when case7 == ABAtenaInkanEntity.KOSHINCOUNTER:                   // XVƒJƒEƒ“ƒ^
                        {
                            if (!UFStringClass.CheckNumber(strValue))
                            {
                                m_cfErrorClass = new UFErrorClass(ABConstClass.THIS_BUSINESSID);
                    ...
                    case var case8 when case8 == ABAtenaInkanEntity.SAKUSEINICHIJI:                  // ì¬“úŽž
                        {
                            if (!UFStringClass.CheckNumber(strValue))
                            {
                                m_cfErrorClass = new UFErrorClass(ABConstClass.THIS_BUSINESSID);
                    ...
                    case var case9 when case9 == ABAtenaInkanEntity.SAKUSEIUSER:                     // ì¬ƒ†[ƒU
                        {
                            if (!UFStringClass.CheckANK(strValue))
                            {
                                m_cfErrorClass = new UFErrorClass(ABConstClass.THIS_BUSINESSID);
                    ...
                    case var case10 when case10 == ABAtenaInkanEntity.KOSHINNICHIJI:                   // XV“úŽž
                        {
                            if (!UFStringClass.CheckNumber(strValue))
                            {
                                m_cfErrorClass = new UFErrorClass(ABConstClass.THIS_BUSINESSID);
                    ...
                    case var case11 when case11 == ABAtenaInkanEntity.KOSHINUSER:                      // XVƒ†[ƒU
                        {
                            if (!UFStringClass.CheckANK(strValue))
                            {
                                m_cfErrorClass = new UFErrorClass(ABConstClass.THIS_BUSINESSID);
...
#error Cannot convert LiteralExpressionSyntax - see comment for details
               /* Cannot convert LiteralExpressionSyntax, System.ArgumentOutOfRangeException: Length cannot be less than zero.
                ...
                ;
#error Cannot convert EmptyStatementSyntax - see comment for details
                /* Cannot convert EmptyStatementSyntax, CONVERSION ERROR: Conversion for EmptyStatement not implemented, please report this issue in '' at character 48595
                ...
                ;
#error Cannot convert EmptyStatementSyntax - see comment for details
                /* Cannot convert EmptyStatementSyntax, CONVERSION ERROR: Conversion for EmptyStatement not implemented, please report this issue in '' at character 48698
...
#error Cannot convert LiteralExpressionSyntax - see comment for details
                ...
                ;
#error Cannot convert EmptyStatementSyntax - see comment for details
                /* Cannot convert EmptyStatementSyntax, CONVERSION ERROR: Conversion for EmptyStatement not implemented, please report this issue in '' at character 49246
